...
class ShowMarket5View extends StatefulWidget {
  ...
  @override
  _ShowMarket5ViewState createState() => _ShowMarket5ViewState();
}

class _ShowMarket5ViewState extends State<ShowMarket5View> {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            const Expanded(
              child: Showmarket5List(), // Wrap it in Expanded
            ),
          ],
        ),
      ),
