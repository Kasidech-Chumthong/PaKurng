...
class ShowMarket5Viewproduct extends StatefulWidget {
  final Market5Model market5Model;
  final int index;

  const ShowMarket5Viewproduct({
    super.key,
    required this.market5Model,
    required this.index,
  });

  @override
  _ShowMarket5ViewproductState createState() => _ShowMarket5ViewproductState();
}

class _ShowMarket5ViewproductState extends State<ShowMarket5Viewproduct> {
  late Market5Model model;

  @override
  void initState() {
    super.initState();
    model = widget.market5Model;
  }

  _launchURL() async {
    const url = 'https://www.facebook.com/profile.php?id=100006195609367';
