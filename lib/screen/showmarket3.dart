...
class ShowMarket3View extends StatefulWidget {
  ...
  @override
  _ShowMarket3ViewState createState() => _ShowMarket3ViewState();
}

class _ShowMarket3ViewState extends State<ShowMarket3View> {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            const Expanded(
              child: Showmarket3List(), // Wrap it in Expanded
            ),
          ],
        ),
      ),
