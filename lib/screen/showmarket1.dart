...
class ShowMarketView extends StatefulWidget {
  ...
  @override
  _ShowMarketViewState createState() => _ShowMarketViewState();
}

class _ShowMarketViewState extends State<ShowMarketView> {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            const Expanded(
              child: Showmarket1List(), // Wrap it in Expanded
            ),
          ],
        ),
      ),
