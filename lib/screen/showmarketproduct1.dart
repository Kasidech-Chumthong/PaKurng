...
class ShowMarket1Viewproduct extends StatefulWidget {
  final Market1Model market1Model;
  final int index;

  const ShowMarket1Viewproduct({
    super.key,
    required this.market1Model,
    required this.index,
  });

  @override
  _ShowMarket1ViewproductState createState() => _ShowMarket1ViewproductState();
}

class _ShowMarket1ViewproductState extends State<ShowMarket1Viewproduct> {
  late Market1Model model;
  String url = 'https://youtu.be/Rp1UCUq9kDs?si=KBvNhxO8lrsDPmJR';

  @override
  void initState() {
    super.initState();
    model = widget.market1Model;
