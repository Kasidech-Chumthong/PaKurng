...
class ShowMarket4View extends StatefulWidget {
  ...
  @override
  _ShowMarket4ViewState createState() => _ShowMarket4ViewState();
}

class _ShowMarket4ViewState extends State<ShowMarket4View> {
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            const Expanded(
              child: Showmarket4List(), // Wrap it in Expanded
            ),
          ],
        ),
      ),
