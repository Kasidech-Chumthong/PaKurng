...
class ShowMarket2Viewproduct extends StatefulWidget {
  final Market2Model market2Model;
  final int index;

  const ShowMarket2Viewproduct({
    super.key,
    required this.market2Model,
    required this.index,
  });

  @override
  _ShowMarket2ViewproductState createState() => _ShowMarket2ViewproductState();
}

class _ShowMarket2ViewproductState extends State<ShowMarket2Viewproduct> {
  late Market2Model model;

  @override
  void initState() {
    super.initState();
    model = widget.market2Model;
  }

  _launchURL() async {
    const url = 'https://www.facebook.com/sirisak.vongsawat';
