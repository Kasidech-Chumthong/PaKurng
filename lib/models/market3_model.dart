...
class Market3Model {
  ...
  factory Market3Model.fromMap(Map<String, dynamic> map) {
    return Market3Model(
  ...
  factory Market3Model.fromJson(String source) => Market3Model.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Market3Model(priceproduct: $priceproduct, detailproduct: $detailproduct, ig: $ig, indepthproduct: $indepthproduct, phone: $phone, product: $product, nameshop: $nameshop, front: $front, back: $back, pathimg: $pathimg)';
  }

  @override
  bool operator ==(covariant Market3Model other) {
