...
class Market2Model {
  ...
  factory Market2Model.fromMap(Map<String, dynamic> map) {
    return Market2Model(
  ...
  factory Market2Model.fromJson(String source) => Market2Model.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Market2Model(priceproduct: $priceproduct, detailproduct: $detailproduct, ig: $ig, indepthproduct: $indepthproduct, phone: $phone, product: $product, nameshop: $nameshop, front: $front, back: $back, pathimg: $pathimg)';
  }

  @override
  bool operator ==(covariant Market2Model other) {
