...
class Market4Model {
  ...
  factory Market4Model.fromMap(Map<String, dynamic> map) {
    return Market4Model(
  ...
  factory Market4Model.fromJson(String source) => Market4Model.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Market4Model(priceproduct: $priceproduct, detailproduct: $detailproduct, ig: $ig, indepthproduct: $indepthproduct, phone: $phone, product: $product, nameshop: $nameshop, front: $front, back: $back, pathimg: $pathimg)';
  }

  @override
  bool operator ==(covariant Market4Model other) {
